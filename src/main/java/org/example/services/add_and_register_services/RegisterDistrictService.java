...
public class RegisterDistrictService {
    ...
    public DistrictDto createDistrict(AddDistrictDto addDistrictDto) {
        ...
        final String addDistrictDtoDistrictName = addDistrictDto.getDistrictName();
        ...
        final DistrictDto districtDto = DistrictDto.builder()
        ...
        final District district = districtMapper.mapDistrictDtoToDistrictEntity(districtDto);
        final District saved = districtRepository.save(district);
